...
- (IBAction)save:(id)sender
{
    ...
    // Insert Product
    if(_product.Id == nil) {
		 [[PLYServer sharedServer] createProduct:_product completion:^(id result, NSError *error) {
    ...
    // Update product
        ...
        [[PLYServer sharedServer] updateProduct:_product completion:^(id result, NSError *error) {
